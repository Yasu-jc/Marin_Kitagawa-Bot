...
import{marinJadiBot}from'./plugins/jadibot-serbot.js'
...
mobile:MethodMobile,
browser:opcion=='1'?[`MarinQR`,'Edge','20.0.04']:methodCodeQR?[`MarinQR`,'Edge','20.0.04']:['Ubuntu','Edge','110.0.1587.56'],
auth:{
creds:state.creds,
...
if(connection=='open'){
console.log(chalk.bold.green('\n❀ Marin Kitagawa Conectada con éxito ❀'))
}
...
MarinJadiBot({pathMarinJadiBot:botPath,m:null,conn,args:'',usedPrefix:'/',command:'serbot'})
}
}
}
}
